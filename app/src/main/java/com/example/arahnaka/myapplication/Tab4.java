...
public class Tab4 extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<Atraction, Tab4.NewsViewHolder> RVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Q = mRef.orderByChild("type").equalTo("ศาสนสถาน");
        ...
        RVAdapter = new FirebaseRecyclerAdapter<Atraction, Tab4.NewsViewHolder>(foodOptions) {
            @Override
            protected void onBindViewHolder(@NonNull Tab4.NewsViewHolder holder, int position, final Atraction model) {
            ...
            @NonNull
            @Override
            public Tab4.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.listitem_food, parent, false);

                return new Tab4.NewsViewHolder(view);
            }
        };
