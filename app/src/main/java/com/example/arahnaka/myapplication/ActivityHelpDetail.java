...
public class ActivityHelpDetail extends AppCompatActivity /*implements LocationListener, GoogleApiClient.ConnectionCallbacks,
...
*/
    ...
    private void getIncomingIntent(){
        ...
        setImage(imageUrl,imageName,des,location,tel);
    }

    private void setImage(String imageUrl,String imageName,String des,String locate,String tel){
    ...
    public void  setNavi(){
        ...
        BottomNavigationViewHelper.enableNavigation(ActivityHelpDetail.this,bottomNavigationViewEx);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(ActivityHelpDetail.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ActivityHelpDetail.this,
