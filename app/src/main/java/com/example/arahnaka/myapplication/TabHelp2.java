...
public class TabHelp2 extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<Helps, TabHelp2.NewsViewHolder> RVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Q = mRef.orderByChild("type").equalTo("สถานีตำรวจ");
        ...
        RVAdapter = new FirebaseRecyclerAdapter<Helps, TabHelp2.NewsViewHolder>(HelpOptions) {
            @Override
            protected void onBindViewHolder(@NonNull TabHelp2.NewsViewHolder holder, int position, final Helps model) {
            ...
            @NonNull
            @Override
            public TabHelp2.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.listitem_help, parent, false);

                return new TabHelp2.NewsViewHolder(view);
            }
        };
