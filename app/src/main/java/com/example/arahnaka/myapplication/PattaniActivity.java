...
public class PattaniActivity extends AppCompatActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pattani);
        ...
        buttonAgreeBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PattaniActivity.this, Setting.class));
            }
        });
    }
    @Override
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(PattaniActivity.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(PattaniActivity.this,
