...
public class ActivityHighlight extends AppCompatActivity /*implements LocationListener, GoogleApiClient.ConnectionCallbacks,
...
/*
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(ActivityHighlight.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ActivityHighlight.this,
