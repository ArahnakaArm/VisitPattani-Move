...
public class Tab2 extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Atraction, Tab2.NewsViewHolder> RVAdapter;
    Query Q;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Q = mRef.orderByChild("type").equalTo("ชุมชน");
        ...
        RVAdapter = new FirebaseRecyclerAdapter<Atraction, Tab2.NewsViewHolder>(foodOptions) {
            @Override
            protected void onBindViewHolder(@NonNull Tab2.NewsViewHolder holder, int position, final Atraction model) {
            ...
            @NonNull
            @Override
            public Tab2.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
