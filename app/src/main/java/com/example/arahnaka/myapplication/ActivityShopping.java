...
public class ActivityShopping extends AppCompatActivity /*implements LocationListener, GoogleApiClient.ConnectionCallbacks,
...
/*
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(ActivityShopping.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ActivityShopping.this,
