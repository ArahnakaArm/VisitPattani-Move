...
public class Travel_Accom extends AppCompatActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    private FirebaseRecyclerAdapter<Atraction, Travel_Accom.NewsViewHolder> RVAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // setNavi();
        ...
        mRef = mFirebaseDatabase.getReference("Places-Home").child("Accom");
        setNavi();
        ...
        RVAdapter = new FirebaseRecyclerAdapter<Atraction, Travel_Accom.NewsViewHolder>(foodOptions) {
            @Override
            protected void onBindViewHolder(@NonNull Travel_Accom.NewsViewHolder holder, int position, final Atraction model) {
            ...
            @NonNull
            @Override
            public Travel_Accom.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.listitem_food, parent, false);

                return new Travel_Accom.NewsViewHolder(view);
            }
        };
...
/*
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(Travel_Accom.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(Travel_Accom.this,
