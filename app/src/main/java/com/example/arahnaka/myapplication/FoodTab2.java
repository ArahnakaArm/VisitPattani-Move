...
public class  FoodTab2 extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<Upload, Tab1.NewsViewHolder> RVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions foodOptions = new FirebaseRecyclerOptions.Builder<Upload>().setQuery(mRef,Upload.class).build();
        RVAdapter = new FirebaseRecyclerAdapter<Upload, Tab1.NewsViewHolder>(foodOptions) {
            @Override
            protected void onBindViewHolder(@NonNull Tab1.NewsViewHolder holder, int position, final Upload model) {
