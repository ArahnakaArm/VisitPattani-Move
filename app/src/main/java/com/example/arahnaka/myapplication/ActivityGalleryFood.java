...
public class ActivityGalleryFood extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galleryfood);
/*
...
*/
    ...
    private void setImage(String imageUrl,String imageName,String des,String locate,String tel){
        ...
        setSupportActionBar(toolbar);
        TextView tele = findViewById(R.id.tele_des);
       ...
       // TextView tele =findViewById(R.id.tel);
        TextView location = findViewById(R.id.locate_des);
        tele.setText(tel);
   ...
   /*/
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(ActivityGalleryFood.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ActivityGalleryFood.this,
