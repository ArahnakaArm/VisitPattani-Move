...
public class PlanningGallery extends AppCompatActivity/*
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.planninggallery);
/*
...
*/
    ...
    private void getIncomingIntent(){
        ...
        setImage(imageUrl,imageName,cost,level,des,des2);


    }
    private void setImage(String imageUrl, String imageName, String cost, String level, String des,String des2){
        TextView Name = findViewById(R.id.planningname);
        TextView Cost =findViewById(R.id.cost_input);
        TextView Level = findViewById(R.id.level);
        TextView Des1 = findViewById(R.id.planningdes);
        TextView Des2 = findViewById(R.id.planningdes2);
        Level.setText(level);
        Des1.setText("   "+des);
        Des2.setText("   "+des2);
        // tele.setText(tel);
      //  Cost.setText(cost);
        ...
        ImageView image=findViewById(R.id.planningimage);
        Glide.with(this)
                .asBitmap()
                .load(imageUrl)
                .into(image);
    ...
    public void  setNavi(){
        ...
        BottomNavigationViewHelper.enableNavigation(PlanningGallery.this,bottomNavigationViewEx);
