...
public class Tab3 extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<Atraction, Tab3.NewsViewHolder> RVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RVAdapter = new FirebaseRecyclerAdapter<Atraction, Tab3.NewsViewHolder>(foodOptions) {
            @Override
            protected void onBindViewHolder(@NonNull Tab3.NewsViewHolder holder, int position, final Atraction model) {
            ...
            @NonNull
            @Override
            public Tab3.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
