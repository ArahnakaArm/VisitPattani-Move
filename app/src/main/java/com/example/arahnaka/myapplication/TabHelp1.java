...
public class TabHelp1 extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<Helps, TabHelp1.NewsViewHolder> RVAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Q = mRef.orderByChild("type").equalTo("โรงพยาบาล");
        ...
        RVAdapter = new FirebaseRecyclerAdapter<Helps, TabHelp1.NewsViewHolder>(HelpOptions) {
            @Override
            protected void onBindViewHolder(@NonNull TabHelp1.NewsViewHolder holder, int position, final Helps model) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final String url = model.getUurl();
                        Intent intent = new Intent(getActivity().getApplicationContext(), HelpDetails.class);
            ...
            @NonNull
            @Override
            public TabHelp1.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.listitem_help, parent, false);

                return new TabHelp1.NewsViewHolder(view);
            }
        };
